...
public class VoiceRecognition : MonoBehaviour {
    ...
    private void Start() {
        ...
        listWords.Add("Ualeo et tu", intro2);
        ...
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-01-salue");
    ...
    private void intro1() {
        ...
        //play intro1 sounds
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-02-quid-aguis");
        narroratorAudio.Play();
        textPromt.text = "Say:\"<b><i>Valeo et tu</b></i>\"";
        progress.text = "20%";
    ...
    private void intro2() {
        ...
        StartCoroutine("Narrarator2");
        textPromt.text = "Say:\"<b><i>Mihi nomen est __</b></i>\"";
        progress.text = "40%";
    ...
    private void intro3() {
        ...
        textPromt.text = "Say:\"<b><i>Habito in__</i></b>\"";
        progress.text = "60%";
    ...
    private void intro5() {
        //play intro5 sounds
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-06-iuliaa");
        narroratorAudio.Play();
    ...
    private void intro6() {
        //play intro6 sounds
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-07-optime");
        narroratorAudio.Play();
        textPromt.text = null;
    ...
    IEnumerator Audio2() {
        ...
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        narroratorAudio.clip = Resources.Load<AudioClip>("Audio/3_Response_Mihi");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        intro2();
    }
    ...
    IEnumerator Audio4() {
        ...
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        narroratorAudio.clip = Resources.Load<AudioClip>("Audio/4_Response_SalveSometing");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        intro4();
    }
    IEnumerator Audio5() {
        ...
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        narroratorAudio.clip = Resources.Load<AudioClip>("Audio/5_Response_Valeo");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        intro5();
    }

    IEnumerator Narrarator2() {
        yield return new WaitForSeconds(1);
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-03-valeo-gratias");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-04-mihi-nomen");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
    }
    ...
    IEnumerator Narrarator3() {
        yield return new WaitForSeconds(1);
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-05-habito-in");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
    }
    ...
    IEnumerator Narrarator4() {
        yield return new WaitForSeconds(1);
        narroratorAudio.clip = Resources.Load<AudioClip>("NewAudio/1-06-iulia");
        narroratorAudio.Play();
        yield return new WaitForSeconds(narroratorAudio.clip.length);
    }
